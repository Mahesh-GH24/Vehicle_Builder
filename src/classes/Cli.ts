    ...
    inquirer
      ...
      .then((answers) => {
        if (answers.vehicleType === 'Car') {
          // create a car if selected
          this.createCar();
        }
        // TODO: add statements to create a truck or motorbike if the user selects the respective vehicle type
        //Create Truck if selected
        else if (answers.vehicleType === 'Truck'){
          //create a Truck
          this.createTruck();
        }
        //Create Motorbike if selected
    ...
    inquirer
      ...
      .then((answers) => {
        ...
        const truck = new Truck(
          // TODO: Call the static generateVin method using the class name Cli.
          Cli.generateVin(),
          answers.color,
          answers.make,
          answers.model,
  ...
  performActions(): void {
    inquirer
      ...
      .then((answers) => {
        ...
        // After calling the findVehicleToTow method, you will need to return to avoid instantly calling the performActions method again 
        //since findVehicleToTow is asynchronous.
        else if (answers.vehicleType === 'Truck' && answers.action === 'Tow') {
